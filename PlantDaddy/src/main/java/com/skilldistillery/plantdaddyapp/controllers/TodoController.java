...
//	public Todo update(@RequestBody Todo todo, @PathVariable Integer todoId, Principal principal) {
//		return todoServ.update(principal.getName(), todoId, todo);
//	}
//	
//	@DeleteMapping("todos/{tid}")
//	public void destroy(HttpServletResponse resp, @PathVariable Integer todoId, Principal principal) {
